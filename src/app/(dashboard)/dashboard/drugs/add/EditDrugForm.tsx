...
import { updateDrug, deleteDrug} from "~/server/animal/animal.service";
...
// Interfejs danych wejściowych (wymagany drugId)
interface DrugData {
    drugId: number;
    petId: number;
    drugType: string;
...
export default function EditDrugForm({ pets, initialData }: { pets: PetOption[], initialData: DrugData }) {
    ...
    const handleDelete = async () => {
            setIsDeleting(true);
            try {
                await deleteDrug(initialData.drugId, initialData.petId);
                setIsDeleted(true);
                
                setTimeout(() => {
                    router.replace("/dashboard/drugs");
                }, 4000);
            } catch (error) {
                console.error(error);
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const drugValues = {
            drugId: initialData.drugId, // ID bierzemy z propsów
            petId: initialData.petId,   // ID zwierzaka bierzemy z propsów (bo select jest disabled)
            ...
            <div className="min-h-[80vh] flex items-center justify-center bg-gray-50 font-sans">
                <div className="bg-white rounded-3xl p-10 max-w-sm w-full shadow-2xl text-center animate-in zoom-in-95 duration-300">
                    ...
                    <p className="text-gray-500">
                        Lek został pomyślnie usunięty. Zaraz wrócisz do listy...
                    </p>
                </div>
            </div>
        );
    ...
    return (
        <div className="w-full py-8 px-4">
            <div className="max-w-2xl mx-auto mb-8 text-center">
                <h1 className="text-3xl font-bold text-gray-900">Edytuj lek</h1>
            </div>
            ...
            >
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="drugType" 
                        required 
                        defaultValue={initialData.drugType}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <input 
                            ...
                            id="drugDate" 
                            required 
                            defaultValue={new Date(initialData.drugDate).toISOString().split('T')[0]} 
                            className={inputStyle} 
                        />
                    </div>
                    <div>
                        ...
                        <input 
                            ...
                            id="drugDose" 
                            required 
                            defaultValue={initialData.drugDose}
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        id="drugNote" 
                        rows={3} 
                        defaultValue={initialData.drugNote ?? ""}
            ...
            {showConfirm && (
                <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-[9000] p-4">
                    <div className="bg-white rounded-3xl p-8 max-w-sm w-full shadow-2xl animate-in fade-in zoom-in-95 duration-200">
                        ...
                        <p className="text-gray-500 text-center text-sm mb-8 leading-relaxed">
                            Ten lek zostanie trwale usunięty. Czy chcesz kontynuować?
                        </p>
